<script >
	import {  quickviews } from "$lib/stores";
	import  clickOutside  from "$lib/utils/clickOutside";
  import { fade } from 'svelte/transition'
</script>
{#if $quickviews}
<div class="relative z-10" role="dialog" aria-modal="true" transition:fade>
  <!--
  ...
  <div class="fixed inset-0 z-10 overflow-y-auto">
    <div class="flex min-h-full items-stretch justify-center text-center md:items-center md:px-2 lg:px-4">
      ...
      -->
      <div class="flex w-full transform text-left text-base transition md:my-8 md:max-w-2xl md:px-4 lg:max-w-4xl" use:clickOutside on:click_outside={quickviews.close} transition:fade>
        <div class="relative flex w-full items-center overflow-hidden bg-white px-4 pb-8 pt-14 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
          <button on:click={quickviews.close} type="button" class="absolute right-4 top-4 text-gray-400 hover:text-gray-500 sm:right-6 sm:top-8 md:right-6 md:top-6 lg:right-8 lg:top-8">
